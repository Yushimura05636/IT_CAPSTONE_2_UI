<template>
  ...
  <div class="container mx-auto flex justify-between items-center scroll-pop">
    ...
    <div class="flex flex-col md:flex-row items-center gap-4 pop-in">
      <a href="login" class="w-full md:w-auto bg-green-600 text-white px-4 py-2 rounded-md hover:bg-green-900 animate__animated animate__pulse animate__infinite flex justify-center items-center">Log in</a>
