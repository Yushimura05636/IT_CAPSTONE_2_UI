...
<div class="info-box">
  ...
  <div class="additional-info text-center mt-6">
    ...
    <ul class="list-disc list-inside text-medium text-gray-600">
      ...
      <li>WEBSITE SERVICES: Implementing website solutions to improve accessibility for clients.</li>
    </ul>
  </div>
</div>
</div>
...
<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
  ...
  <div class="team-member p-4 bg-white rounded-lg shadow-md text-center">
    ...
    <p class="text-center text-gray-600 mt-6">
        Join us in our mission to empower dreams through microfinance. Together, we can make a difference!
    </p>
</section>
    ...
    <div class="flex flex-col md:flex-row items-center gap-4 pop-in">
      <a href="login" class="w-full md:w-auto bg-teal-600 text-white px-6 py-2 rounded-md hover:bg-teal-700 focus:outline-none focus:ring-2 focus:ring-teal-700 focus:ring-opacity-50 animate__animated animate__pulse animate__infinite flex justify-center items-center whitespace-nowrap">Log in</a>
      <a href="signup"
        class="w-full md:w-auto bg-teal-600 text-white px-6 py-2 rounded-md hover:bg-teal-700 focus:outline-none focus:ring-2 focus:ring-teal-700 focus:ring-opacity-50 animate__animated animate__pulse animate__infinite flex justify-center items-center whitespace-nowrap"
        aria-label="Sign Up">
          Client Sign in
      </a>
    </div>
...
.info-box {
  ...
  width: 900px; /* Set a fixed width for the box */
  height: 500px;; /* Allow height to adjust based on content */
  background-color: white;
  border: 1px solid green;
  padding: 20px; /* Increased padding */
  border-radius: 12px;
  box-shadow: 0 6px 10px rgba(28, 161, 28, 0.479);
  z-index: 20;
