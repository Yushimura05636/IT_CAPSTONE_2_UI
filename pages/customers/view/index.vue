...
<NuxtLayout name="admin">
    ...
    <form>
        ...
        <!-- <div>
            <label for="personality_status" class="block text-gray-700">Personality Status</label>
            <select v-model="personality.personality_status_code" id="personality_status" class="w-full border rounded-lg px-4 py-2">
            <option v-for="status_code in state.personality_status_code" :key="status_code.id" :value="status_code.id">
    ...
    <div class="mt-4 flex justify-end">
        <button type="submit" class="px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-500"  @click="updateCustomer('Approved')">
            Approve
        </button>
        <button type="submit" class="ml-2 px-4 py-2 bg-red-600 text-white rounded-lg hover:bg-red-500"  @click="updateCustomer('Reject')">
            Reject
        </button>
    </div>
</NuxtLayout>
