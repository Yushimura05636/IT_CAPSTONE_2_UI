        ...
        <table class="min-w-full bg-white">
          ...
          <tbody>
            <tr v-for="(payment, index) in filteredPayments" :key="index">
              ...
              <td class="py-2 px-4">{{ payment.dateCreated }}</td>
              <td class="py-2 px-4">{{ payment.datePrepared }}</td>
              <td class="py-2 px-4">{{ payment.documentStatus }}</td>
              <td class="py-2 px-4">{{ payment.preparedBy }}</td>
