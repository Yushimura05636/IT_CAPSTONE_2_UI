<template>
    ...
    <div class="max-w-screen-xl mx-auto px-4 md:px-8">
      ...
      <div class="items-start justify-between md:flex mt-8">
        <div class="max-w-lg">
          <h3 class="text-gray-800 text-xl font-bold sm:text-2xl mb-4">Payment of Duration</h3>
        </div>
      </div>
        ...
        <table class="w-full table-auto text-sm text-left">
          <thead class="bg-gray-50 text-gray-600 font-medium border-b">
            <tr>
              ...
              <th class="py-3 px-6">Number of Payment</th>
          ...
          <tbody class="text-gray-600 divide-y">
            <tr v-for="(item, idx) in filteredTableItems" :key="idx">
              ...
              <td class="px-6 py-4 whitespace-nowrap">{{ item.number_of_payments }}</td>
