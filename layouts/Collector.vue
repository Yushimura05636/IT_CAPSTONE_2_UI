<template>
        ...
        <section class="mb-6">
          <h1 class="text-xl sm:text-2xl font-semibold">
            Welcome, <span class="font-bold text-gray-700">Collector</span>
          </h1>
...
const navigation = [
  { name: "Collect Payment", href: "/", icon: ChartPieIcon, current: false },

  { name: "View Collection List", href: "/", icon: ChartPieIcon, current: false },
